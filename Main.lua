-- Blox Fruits Auto-Farm & Fruit Spawner Script (Mobile & Delta Executor)
...
local function spawnFruit()
    ...
    local spawnEvent = game:GetService("ReplicatedStorage"):WaitForChild("SpawnFruitEvent")
    if spawnEvent then
...
local function autoFarm()
    while autoFarmEnabled do
        ...
        local collectEvent = game:GetService("ReplicatedStorage"):WaitForChild("CollectFruitEvent")
